...
Take the main pump and mount it on its bracket with a M3x15 screw.  
...
![assembled lower rail](img/IMG_0954.jpg)  
...
Place both ends of the rail (left and right) between pairs of X-mounts and tighten the nuts. Make sure that perpendicular rods are in front of the rail, not on the real side.  
![two lower rails in different containers](img/IMG_0962.jpg)  
