...
module xmount(thickness=16,diameter=8,tightening_gap=0.5,half=false,slot=2) {
  difference() {
...
if (part=="OPTIONAL_nut_spinner") {
  nutspinner(50,40,nut_width+6,nut_width+2*tightening_gap,rod_diameter+tightening_gap*2,nut_width);
}